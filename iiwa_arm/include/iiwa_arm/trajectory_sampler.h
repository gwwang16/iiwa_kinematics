...
#ifndef IIWA_ARM_TRAJECTORY_SAMPLER_H
#define IIWA_ARM_TRAJECTORY_SAMPLER_H
...
#include <iiwa_arm/CalculateIK.h>
...
private:
  ...
  const std::string BIN_MESH_PATH =
    "package://iiwa_arm/models/kinematics_bin/kinematics_bin.dae";
...
#endif  // IIWA_ARM_TRAJECTORY_SAMPLER_H
