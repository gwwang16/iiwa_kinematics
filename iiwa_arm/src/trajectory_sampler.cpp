...
#include <iiwa_arm/trajectory_sampler.h>
    ...
    eef_group(GRIPPER_GROUP)
{
  ...
  ground_prim.dimensions[0] = 3.0;
  ground_prim.dimensions[1] = 3.0;
  ...
  while (ros::ok())
  {
    ...
    ros::ServiceClient client =
      nh.serviceClient<iiwa_arm::CalculateIK>("calculate_ik");
    iiwa_arm::CalculateIK srv;
    ...
    system("rosrun iiwa_arm target_spawn.py");
    ros::Duration(1.0).sleep();
    ...
    moveit_msgs::CollisionObject &collision_object)
{
  ...
  Eigen::Vector3d model_scaling(0.3, 0.3, 0.3);

  shapes::Mesh* m = shapes::createMeshFromResource(mesh_path, model_scaling);
